...
const AdminPannel = () => {
    ...
    const handleLogout = async () => {
        await fetch("http://localhost/backend/api/?action=principallogout", {
            credentials: "include"
        });
        navigate("/Dashboard");
    };
        ...
        <>
            <nav className="navbar navbar-expand-lg bg-body-tertiary">
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand" to={"/Principal"}>Principal</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <Link to={"/Principal/search"} className="btn btn-info rounded-5 mx-2">
